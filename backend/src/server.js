...
// Em production, servir frontend compilado + static files do backend
const publicPath = path.join(__dirname, '../public');
app.use(express.static(publicPath));

// Em production, servir frontend da pasta dist
...
app.get('/:path(*)', (req, res, next) => {
  // Se não for API, servir index.html para SPA routing
